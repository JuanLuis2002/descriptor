...
function desactivarDescriptor(id) {
    Swal.fire({
        ...
        html: '<div class="deactivate-modal"><label for="motivo" class="deactivate-label">Motivo de desactivación</label><textarea id="motivo" class="swal2-textarea deactivate-textarea" placeholder="Explique brevemente el motivo..." rows="4"></textarea></div>',
        customClass: {
            popup: 'deactivate-popup',
            title: 'deactivate-title',
            htmlContainer: 'deactivate-html',
            actions: 'deactivate-actions',
            confirmButton: 'deactivate-confirm',
            cancelButton: 'deactivate-cancel'
        },
        showCancelButton: true,
