    ...
    cargarPendientes: function() {
        ...
        for (var i = 0; i < pendientes.length; i++) {
            ...
            html += '<div class="col-12 col-md-6 col-lg-4 mb-3"><div class="card h-100">' +
                ...
                '<div class="card-footer bg-white"><button class="btn btn-sm ' + (tieneFirma ? 'btn-success' : 'btn-warning') + ' w-100" onclick="CTController.firmar(' + d.id + ')"><i class="fas fa-signature"></i> ' + (tieneFirma ? 'Ver Firma' : 'Firmar Descriptor') + '</button></div></div></div>';
        }
        html += '</div>';
