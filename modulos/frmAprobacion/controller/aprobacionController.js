...
var AprobacionController = {
    ...
    renderPagination: function(total, start, end, totalPages) {
        var html = '<div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-2 p-3 border-top">' +
            ...
            '<button class="btn btn-sm ' + (this.pageSize === 5 ? 'btn-primary' : 'btn-link') + '" onclick="AprobacionController.cambiarPageSize(5)">5</button>' +
            '<button class="btn btn-sm ' + (this.pageSize === 10 ? 'btn-primary' : 'btn-link') + '" onclick="AprobacionController.cambiarPageSize(10)">10</button>' +
            '<button class="btn btn-sm ' + (this.pageSize === 25 ? 'btn-primary' : 'btn-link') + '" onclick="AprobacionController.cambiarPageSize(25)">25</button>' +
