...
var THController = {
    ...
    verDetalle: function(id) {
        ...
        var botonEditarRelacionesInternas = puedeCompletarTH ? '<button type="button" class="btn btn-sm btn-outline-primary mt-2" onclick="THController.editarRelacionesInternas(' + id + ')"><i class="fas fa-edit"></i> Editar Relaciones Internas</button>' : '';
        var botonEditarRelacionesExternas = puedeCompletarTH ? '<button type="button" class="btn btn-sm btn-outline-primary mt-2" onclick="THController.editarRelacionesExternas(' + id + ')"><i class="fas fa-edit"></i> Editar Relaciones Externas</button>' : '';
        var botonEditarRequerimientos = puedeCompletarTH ? '<button type="button" class="btn btn-sm btn-outline-primary mt-2" onclick="THController.editarRequerimientos(' + id + ')"><i class="fas fa-edit"></i> Editar Requerimientos</button>' : '';
        var botonEditarRiesgos = puedeCompletarTH ? '<button type="button" class="btn btn-sm btn-outline-primary mt-2" onclick="THController.editarRiesgos(' + id + ')"><i class="fas fa-edit"></i> Editar Riesgos</button>' : '';
